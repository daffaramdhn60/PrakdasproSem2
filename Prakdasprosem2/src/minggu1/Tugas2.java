...
public class Tugas2 {
    ...
    public static void inputJadwal(String[][] jadwal, int n) {
        for (int i = 0; i < n; i++) {
            ...
            jadwal[i][0] = daffa.nextLine();

            System.out.print("Ruang            : ");
            jadwal[i][1] = daffa.nextLine();

            System.out.print("Hari Kuliah      : ");
            jadwal[i][2] = daffa.nextLine();

            System.out.print("Jam Kuliah       : ");
            jadwal[i][3] = daffa.nextLine();
        }
    }
    ...
    public static void cariBerdasarkanHari(String[][] jadwal, int n) {
        ...
        String cariHari = daffa.nextLine();
    ...
    public static void cariBerdasarkanMatkul(String[][] jadwal, int n) {
        ...
        String cariMatkul = daffa.nextLine();
    ...
    public static void main(String[] args) {
        ...
        int n = Integer.parseInt(daffa.nextLine());
